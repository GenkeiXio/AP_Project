...
@push('styles')
    <style>
        ...
        html {
            ...
            height: 100%;
            overflow: hidden;
            /* Prevents scrollbars if you want a fixed game screen */
        }
        ...
        @keyframes pinPulse {
            ...
            50% {
                filter: drop-shadow(0 0 20px rgba(255, 71, 87, 0.9));
            }
        ...
        .vn-dialogue-box::after {
            ...
            position: absolute;
            left: 40px;
            /* Adjusted to look better on desktop */
            bottom: -22px;
            width: 0;
            height: 0;
        ...
        .vn-continue {
            ...
            text-align: right;
            color: #8fd18f;
            /* Light green text for the prompt */
        }
...
@section('content')
    ...
    <div class="mobile-nav" id="mobileNav">
        <ul>
            ...
            <li><a href="{{ route('module.home') }}">📘 Kalagayan, Suliranin At Pagtugon Sa Isyung Pangkapaligiran Ng
                    Pilipinas</a></li>
            <li><a href="#" onclick="return false;" style="opacity: 0.6; cursor: not-allowed;">📗 Module 3
                    <?php if (!$module3_unlocked): ?>🔒<?php endif; ?></a></li>
            <li><a href="#" onclick="return false;" style="opacity: 0.6; cursor: not-allowed;">📙 Module 4
                    <?php if (!$module4_unlocked): ?>🔒<?php endif; ?></a></li>
        </ul>
    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const module2Done = module3Unlocked;
            const module3Done = module4Unlocked;
            ...
            if (module4Unlocked && !hasSeen(DIALOGUES.mod3)) {
                startDialogue([
                    { text: "Magaling! Natapos mo ang modyul 3", name: "Mga Guro", image: "{{ asset('pictures/vn_box_teacher2.png') }}" },
            ...
            if (!hasSeen(DIALOGUES.intro)) {
                startDialogue([
                    ...
                    {
                        text: "Sa bawat hakbang, ikaw ay matututo at makakagawa ng tamang desisyon. Ang iyong layunin ay unawain ang kalagayan ng kapaligiran at mag-isip ng mga paraan upang makatulong sa pangangalaga ng kalikasan. Handa ka na ba? Simulan na natin ang iyong paglalakbay.",
                        image: "{{ asset('pictures/vn_box_teacher4.png') }}"
                    }
                ], DIALOGUES.intro);
            }
