...
@section('title', 'Hamon at Tugon: Module 4 Panghuling Pagsusulit')
...
<div class="main-wrapper">
        ...
        <div class="pretest-card" id="pretestCard">
            ...
            <div class="last-score-box" id="lastScoreBox">
                ...
                <div class="no-attempts-actions" id="noAttemptsActions">
                    <a href="{{ route('module4.performance') }}" class="btn-primary" style="min-width: 200px;">
                ...
                <div class="result-page" id="resultPage" aria-live="polite">
                    <div class="result-box show" id="resultBox">
                        ...
                        <div class="result-actions" id="resultActions">
                            ...
                            <a href="{{ route('inner.map4') }}" class="btn-primary">Magpatuloy →</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div id="passModal" class="modal-overlay">
        <div class="modal-box">
            ...
            <p>
                Mahusay! Ipinapakita ng iyong resulta na nauunawaan mo na ang mga konsepto ng disaster risk reduction at management. 
...
<script>
    ...
    window.addEventListener('load', () => {
        ...
        fetch("{{ route('module4.posttest.status') }}")
            .then(res => res.json())
            .then(data => {
                remainingAttempts = Math.max(0, 2 - (data.attempts_used || 0));
                highestScore = data.highest_score || null;
                
                updateRetryIndicator();
                
                if (data.max_attempts_reached || !data.can_take_exam) {
                    lockQuiz();
                } else {
                    shuffleQuestionsAndChoices();
                    renderAllQuestions();
