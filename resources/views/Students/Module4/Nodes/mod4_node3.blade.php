            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px;">
                <div>
                    <h1><i class="fas fa-house-damage"></i> NODE 3: Malakas na Lindol 
                        <span style="font-size: 1rem; background: var(--vintage-leather); padding: 5px 18px; border-radius: 3px; margin-left: 16px; color: var(--gold-trim); border: 1px solid var(--gold-trim);">Bogo City, Cebu</span>
                    </h1>
                </div>
            </div>
                ...
                <div class="media-container">
                    ...
                    <div class="video-container">
                        ...
                        <div class="video-wrapper">
                            <iframe 
                                id="youtubeVideo"
                                src="https://www.youtube.com/embed/48qGLqpyutQ?enablejsapi=1" 
