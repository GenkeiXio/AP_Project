    ...
    <style>
        * {
        ...
        .btn-references:hover {
            transform: translateY(-3px);
            box-shadow: 0 18px 40px rgba(108, 117, 125, 0.45);
            color: white;
        }

        .btn-back-summary {
            background: none;
            border: 2px solid rgba(124, 231, 255, 0.4);
            color: #7ce7ff;
            padding: 10px 25px;
            border-radius: 50px;
            font-weight: 700;
...
<body>
    ...
    <div class="modal-overlay" id="rewardModal">
        <div class="reward-modal">
            ...
            <button class="complete-house-btn" onclick="startHouseAnimation()">Tapusin ang Konstruksyon</button>
        </div>
    </div>
    ...
    <div id="finalAnimOverlay" class="animation-overlay">
        <div class="anim-wrapper">
            <img src="{{ asset('pictures/Module 3/finalhousewalls.png') }}" id="finalWalls" class="house-part" alt="Walls">
            <img src="{{ asset('pictures/Module4/mod4housepart.png') }}" id="mod4Roof" class="house-part" alt="Roof">
            <img src="{{ asset('pictures/Module4/finalrewardhouse.png') }}" id="completeHouse" class="house-part" alt="Complete House">
        </div>
        ...
        <div id="finalText" class="final-text-container">
            ...
            <div>
                ...
                <a href="{{ route('module4.references') }}" class="btn-cert btn-references">
                    📚 View References
                </a>
            </div>
            <br>
            <button class="btn-back-summary" onclick="closeFinalOverlay()">
                ↶ Bumalik sa Buod
            </button>
        </div>
    </div>
    ...
    <script>
        // ============================================
        // FIXED JAVASCRIPT - NO NESTED SCRIPT TAGS
        // ============================================
        ...
        function startHouseAnimation() {
            ...
            completeHouse.style.display = 'block';
            
            walls.classList.remove('fade-in-center');
            roof.classList.remove('slide-in-roof');
            completeHouse.classList.remove('fade-in-center');
            finalText.classList.remove('visible-text');
            
            walls.style.opacity = '0';
            walls.style.transform = 'scale(0.9)';
            roof.style.opacity = '0';
            roof.style.transform = 'translate(150px, -40px)';
            completeHouse.style.opacity = '0';
            completeHouse.style.transform = 'scale(0.8)';
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    // Step 2: Roof slides in
                    roof.classList.add('slide-in-roof');
                    
                    setTimeout(() => {
                        // Step 3: Fade out walls and roof
                        walls.style.opacity = '0';
                        ...
                        setTimeout(() => {
                            // Step 4: Hide walls and roof, show complete house
        ...
        window.addEventListener('load', function() {
            // Show reward modal after 1 second
            setTimeout(function() {
