...
@push('styles')
    <style>
        ...
        .btn-save-char:hover {
            ...
            box-shadow: 0 6px 18px rgba(77, 168, 98, 0.38);
        }
        ...
        .toast.success {
            background: linear-gradient(135deg, #4da862, #3a8050);
        }
...
$charMap = [
    'boy_uniform' => ['Juan', 'Mag-aaral na Lalaki'],
    'girl_uniform' => ['Maria', 'Mag-aaral na Babae'],
    'rizal' => ['Rizal', 'Pambansang Bayani'],
    'bonifacio' => ['Bonifacio', 'Ama ng Katipunan'],
    'gabriela' => ['Gabriela', 'Henerala ng Ilocos'],
    'neutral_hero' => ['Lihim', 'Hindi pa nakikilalang bayani'],
];

[$charName, $charRole] = $charMap[$avatar] ?? ['Explorer', 'Mag-aaral'];
            @endphp
                ...
                <div>
                    <div class="char-card-profile">
                        ...
                        <div class="current-char-wrap" id="currentCharDisplay">
                            @if($avatar === 'boy_uniform')
                                <img src="{{ asset('pictures/chibi_boy.png') }}" class="char-opt-svg">
                            @elseif($avatar === 'girl_uniform')
                                <img src="{{ asset('pictures/girl_pink.png') }}" class="char-opt-svg">
                            @elseif($avatar === 'rizal')
                                <img src="{{ asset('pictures/Jose Rizal.png') }}" class="char-opt-svg">
                            @elseif($avatar === 'bonifacio')
                                <img src="{{ asset('pictures/Bonifacio.png') }}" class="char-opt-svg">
                            @elseif($avatar === 'gabriela')
                                <img src="{{ asset('pictures/Gabriela silang (2).png') }}" class="char-opt-svg">
                            @elseif($avatar === 'neutral_hero')
                ...
                <div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-row">
                                <input type="text" id="usernameInput" value="{{ $student->username }}"
                                    placeholder="Bagong username..." maxlength="50" autocomplete="off" />
                    ...
                    <div class="section-card">
                        ...
                        <div class="info-row">
                            ...
                            <span
                                class="info-val">{{ $student->last_played ? $student->last_played->diffForHumans() : 'Ngayon' }}</span>
                        </div>
                        <div class="info-row">
        ...
        async function saveCharacter() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    const [name, role] = map[selectedChar] || ['Explorer', 'Mag-aaral'];

                    document.getElementById('currentCharName').textContent = name;
                    document.getElementById('currentCharRole').textContent = role;
                } else {
