...
.book-spine::after {
    ...
    z-index: 60; /* Layered on top of flipping pages */
...
.left-page { border-radius: 3px 0 0 3px; border-right: 1px solid rgba(0,0,0,0.2); }
.right-page { border-radius: 0 3px 3px 0; border-left: 1px solid rgba(0,0,0,0.2); }
...
.card-item:hover { transform: scale(1.1) rotate(-2deg); }
.card-item img { width: 100%; height: 110px; object-fit: cover; filter: sepia(0.4) contrast(1.1); }
...
.btn-vintage:hover { background: #3d2a25; transform: translateY(-2px); }
...
<div class="ap-wrapper">
    ...
    <div id="gameHUD" class="hidden" style="width: min(850px, calc(100vw - 24px)); color: var(--gold-trim); display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 0.9rem;">
    ...
    <div class="book-container">
        <div class="book-spine">
            ...
            <div class="page left-page">
                <div id="introLeft">
                    <h1 style="font-family: 'Nunito', sans-serif; font-weight: 800; border-bottom: 2px solid var(--ink);">TALAAN NG BAYAN</h1>
            ...
            <div class="page right-page">
                ...
                <div id="finalResult" class="hidden" style="text-align: center; padding: 20px;">
                    <h2 id="resultTitle" style="font-family: 'Nunito', sans-serif; font-weight: 800;">MISYON: TAGUMPAY</h2>
                    ...
                    <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                        ...
                        <button id="btnToMap" onclick="window.location.href='{{ route('inner.map3') }}'" class="btn-vintage" style="display:none;">BUMALIK SA MAPA</button>
                    </div>
            ...
            <div id="flip2" class="flip-layer" style="z-index: 99;">
                <div>
                    <h2 style="color: var(--danger); font-family: 'Nunito', sans-serif; font-weight: 800;">BANTAY-ORAS!</h2>
                    <p style="line-height: 1.6;">"Habang tumatagal, kumukupas ang tinta sa talaan. Sa bawat pahina, mayroon ka lamang <strong>10 segundo</strong> upang maitugma ang tamang larawan sa tamang konsepto."</p>
                    <p style="font-size: 0.9rem; margin-top: 15px; line-height: 1.6;">Kapag umabot sa 5 segundo ang natitirang oras, magiging pula ang orasan bilang huling babala.</p>
            ...
            <div id="flip3" class="flip-layer" style="z-index: 100;">
                <div>
                    <p style="font-size: 1.05rem; line-height: 1.6;">
                        "Sa bawat pahina ng talaan, nakaukit ang alaala ng mga unos na minsang yumanig sa ating barangay: bagyo, baha,
                        at pagguho. Ngunit kasabay ng bawat sakuna ay mga aral kung paano tayo makaiiwas sa mas malalang pinsala."
                    </p>
                    <p style="font-size: 0.95rem; line-height: 1.6; margin-top: 14px;">
                        "Ikaw ngayon ang tagapag-ingat ng talaan. Ayusin mo ang mga larawan upang maibalik ang wastong kahulugan ng
            ...
            <div id="flip1" class="flip-layer" style="z-index: 101;">
                <div>
                    <p style="font-size: 1.15rem; line-height: 1.7;">"Sa isang maulang gabi, may natagpuan akong lumang talaan sa silid-imbakan ng barangay. Halos punit na ang mga pahina,
...
function startQuest() {
    flipPage(2);
    // Bigyan ng konting delay para matapos ang animation bago ipakita ang UI
    setTimeout(() => {
        document.getElementById('gameHUD').classList.remove('hidden');
        document.getElementById('timerContainer').classList.remove('hidden');
