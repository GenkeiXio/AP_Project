...
@section('title', 'Module 3 : Flood Safety Activity')
...
<style>
    ...
    :root {
        ...
        --hp-green: #2ecc71;
        --danger-red: #e74c3c;
        /* Lighter Wooden Palette - Matching other activities */
        --wood-dark: #5c3d2e;
        --wood-medium: #8b6b4f;
        --wood-light: #d2b48c;
        --wood-bg: #d4b896;
    ...
    /* VIDEO SECTION - Wooden Container */
    ...
    .btn-proceed {
        ...
        transition: 0.3s;
        cursor: pointer;
        box-shadow: 0 6px 0 #b8960f;
    }

    .btn-proceed:hover {
        transform: translateY(-3px);
        box-shadow: 0 9px 0 #b8960f;
        background: #ffe44d;
    }

    .btn-proceed:active {
        transform: translateY(6px);
        box-shadow: 0 2px 0 #b8960f;
    }

    /* QUEST CARD - Wooden Container */
    .quest-container {
        background: var(--wood-panel);
        background-image: url('https://www.transparenttextures.com/patterns/wood-pattern.png');
        border-radius: 20px;
    ...
    .quest-card {
        ...
        padding: 50px 40px;
        text-align: center;
        box-shadow: 0 15px 0px var(--wood-dark);
        position: relative;
    ...
    .modal-gameover {
        background: var(--wood-panel);
        background-image: url('https://www.transparenttextures.com/patterns/wood-pattern.png');
        border: 6px solid var(--danger-red);
        border-radius: 30px;
        padding: 50px 40px;
        max-width: 500px;
        width: 100%;
    ...
    .modal-gameover .btn-retry:hover {
        transform: translateY(-3px);
        box-shadow: 0 9px 0 #922b21;
        background: #e74c3c;
    }

    .modal-gameover .btn-retry:active {
        transform: translateY(6px);
        box-shadow: 0 2px 0 #922b21;
    }

    .modal-gameover .score-display {
    ...
    .modal-gameover .score-display span {
        font-family: 'Bungee', cursive;
        font-size: 1.8rem;
        color: var(--safety-yellow);
    }
...
@section('content')
    ...
    <div id="gameover-modal">
        <div class="modal-gameover">
            ...
            <h2>GAME OVER!</h2>
            <p>Naubos ang iyong HP. Hindi mo nakumpleto ang misyon sa pagbaha. Subukan muli upang matutunan ang tamang safety protocols!</p>
            <div class="score-display">
                <div style="font-size: 0.9rem; color: var(--wood-dark); font-weight: 600;">SCORE</div>
                <span id="gameover-score">0</span>
            </div>
            <button class="btn-retry" onclick="retryGame()">🔄 SUBUKAN MULI</button>
        </div>
    </div>
    ...
    <div class="game-stage">
        <div id="game-play">
            ...
            <!-- VIDEO SECTION - First shown -->
            <div id="video-section" class="video-section-container">
                <div class="video-grid">
                    <div class="video-wrapper">
                        <p class="text-center small mb-2" style="color: var(--wood-dark); font-weight: 700;">Ano ang Pagbaha at Flashflood?</p>
                        <iframe src="https://www.youtube.com/embed/9hQZCiZ21fk" allowfullscreen></iframe>
                    </div>
                    <div class="video-wrapper">
                        <p class="text-center small mb-2" style="color: var(--wood-dark); font-weight: 700;">Safety Guide tuwing Pagbaha</p>
                        <iframe src="https://www.youtube.com/embed/AoraXNrMp48" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="text-center">
                    <button class="btn-proceed" onclick="showGame()">📖 MAGPATULOY SA MGA TANONG</button>
                </div>
            </div>

            <!-- GAME SECTION - Hidden initially -->
            <div id="game-section" class="quest-container">
        ...
        <div id="result-screen">
            <h1 style="font-family: 'Bungee';">MISSION COMPLETE!</h1>
            <div class="display-1 fw-bold my-4" id="final-score" style="color: #27ae60;">0</div>
            <p class="fs-4">Magaling! Natapos mo ang gawain!</p>
            <p class="fs-5">Sa activity na ito, natutunan mo kung alin ang mga ligtas at delikadong gawain sa panahon ng baha at bagyo. Mahalaga ang pagiging handa, maingat, at pagsunod sa tamang hakbang upang mapanatiling ligtas ang sarili at pamilya. Tandaan: Ang tamang kaalaman ay susi sa kaligtasan! 🌧️</p>
