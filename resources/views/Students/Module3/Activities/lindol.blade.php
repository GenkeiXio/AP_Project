...
<head>
    ...
    <style>
        ...
        .report-file {
            ...
            width: 100%;
            max-width: 650px;
            /* Mula 500px ginawang 650px */
            padding: 35px;
            /* Dinagdagan ang padding */
...
<body>
    ...
    <div id="decision-modal"
        style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%) scale(0); z-index: 1000; padding: 25px 50px; background: #000; border: 5px solid var(--hazard-yellow); font-family: 'Oswald'; font-size: 4rem; transition: 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); pointer-events: none;">
        TAMA</div>
    ...
    <div class="container game-container">
        ...
        <div id="briefing-layer">
            <div class="mb-4">
                <div class="row g-2">
                    <div class="col-md-6"><iframe width="100%" height="240"
                            src="https://www.youtube.com/embed/dJpIU1rSOFY" frameborder="0"
                            style="border: 2px solid var(--hazard-yellow); border-radius: 8px;"></iframe></div>
                    <div class="col-md-6"><iframe width="100%" height="240"
                            src="https://www.youtube.com/embed/AxpSZSsxvf8" frameborder="0"
                            style="border: 2px solid var(--hazard-yellow); border-radius: 8px;"></iframe></div>
                </div>
            </div>
        ...
        <div id="end-layer" class="hidden">
            <div class="congrats-card">
                <h2 class="text-center" style="color: var(--success-green); font-family: 'Oswald';">MISYON TAGUMPAY! 🎖️
                </h2>
                <div class="fs-5" style="text-align: justify; font-size: 0.95rem; line-height: 1.5; color: #eee;">
                    <p>Napagtagumpayan mong matukoy ang mga tamang gawain sa oras ng sakuna. Ipinapakita nito na handa
                        ka at may sapat na kaalaman upang mapanatiling ligtas ang iyong sarili at ang iba.</p>
                    <p style="color: #bbb;">Natutunan mo ang kahalagahan ng <strong>emergency kits</strong>,
                        <strong>earthquake drills</strong>, at ang tamang kilos tulad ng <strong>Duck, Cover, and
                            Hold</strong>.
                    </p>
                    <p class="text-center mt-3 fw-bold" style="color: var(--hazard-yellow); font-size: 1.1rem;">Ang
                        handa ay ligtas! 👏</p>
                </div>
                <div class="text-center mt-4">
                    <a href="{{ route('bulkan.activity') }}" class="btn-next"
                        style="font-family: 'Oswald'; font-size: 1.2rem; padding: 10px 35px; background: var(--hazard-yellow); color: #000; border-radius: 5px; text-decoration: none; font-weight: bold;">SUSUNOD
                        NA ARALIN ➡️</a>
                </div>
            </div>
        </div>
