...
<style>
    ...
    body {
        ...
        background: #1a1a1a url('https://www.transparenttextures.com/patterns/dark-leather.png');
    ...
    .instruction-overlay {
        ...
        padding: 30px; border: 2px solid var(--ginto);
    }
    ...
    .scroll-header h1 {
        font-family: 'Pirata One'; color: var(--ginto);
        font-size: 42px; margin: 0; letter-spacing: 2px;
    }
    ...
    .briefing-box ul {
        margin: 10px 0; padding-left: 20px; list-style-type: '⚔ ';
    }

    .briefing-box li { margin-bottom: 10px; color: var(--papel); }

    .btn-start {
        margin-top: 30px;
        background: var(--kahoy); color: var(--ginto);
        border: 2px solid var(--ginto);
        padding: 15px 40px; font-family: 'Cinzel';
    ...
    .btn-start:hover {
        background: var(--ginto); color: var(--kahoy);
    ...
    .card-header {
        background: var(--kahoy); color: var(--ginto);
        padding: 15px; text-align: center; border-bottom: 3px solid var(--ginto);
    }

    .card-header h2 { font-family: 'Cinzel'; margin: 0; font-size: 18px; }
    ...
    .button-grid { padding: 20px; display: grid; gap: 10px; }

    .choice-btn {
        background: white; border: 2px solid var(--kahoy);
        padding: 12px; cursor: pointer; font-family: 'Cinzel';
        font-weight: bold; transition: 0.2s; color: var(--kahoy);
        display: flex; justify-content: space-between; align-items: center;
    }

    .choice-btn:hover { background: var(--kahoy); color: var(--ginto); transform: translateX(5px); }
    ...
    .stamp {
        font-family: 'Pirata One'; font-size: 90px;
        transform: rotate(-15deg); padding: 10px 40px; border: 10px double;
    ...
    .progress-container { height: 6px; background: #ddd; width: 100%; }
    #progressBar { height: 100%; background: var(--ginto); width: 0%; transition: 0.3s; }
</style>
</head>
<body>
    ...
    <div class="game-card">
        <div id="instructionScreen" class="instruction-overlay">
            ...
            <div class="briefing-box">
                ...
                <ul>
                    ...
                    <li>Tukuyin kung ito ay isinasagawa <strong>Bago</strong>, <strong>Habang</strong>, o <strong>Pagkatapos</strong> ng bagyo.</li>
                    <li>Maging mabilis at tumpak sa iyong pagpapasya.</li>
                </ul>
                <p style="font-size: 13px; font-style: italic; opacity: 0.8;">"Ang kahandaan ay ang susi sa kaligtasan ng ating komunidad."</p>
            </div>
        ...
        <div id="resultArea" style="display:none; padding: 40px; text-align: center;">
            <h2 style="font-family: 'Pirata One'; font-size: 45px; margin: 0; color: var(--kahoy);">ULAT NG PAGSULIT</h2>
            <hr style="border: 1px solid var(--kahoy); opacity: 0.2;">
            <div style="font-size: 65px; font-weight: 900; color: var(--kahoy); margin: 15px 0;" id="finalScoreDisplay">0/12</div>
            <p id="rankLabel" style="font-weight: bold; text-transform: uppercase; letter-spacing: 2px; color: var(--kahoy);"></p>
            <button class="choice-btn" style="width:100%; margin-top: 30px; justify-content: center; background:var(--kahoy); color:var(--ginto);" 
