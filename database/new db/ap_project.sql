...
INSERT INTO `characters` VALUES (1,'Warrior','Fighter',100,20,15,NULL,NULL),(2,'Mage','Spellcaster',70,30,10,NULL,NULL),(3,'Archer','Ranged',80,25,12,NULL,NULL);
...
--
-- Table structure for table `module4_node1s`
--

DROP TABLE IF EXISTS `module4_node1s`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `module4_node1s` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `student_id` bigint unsigned NOT NULL,
  `problem_number` int NOT NULL,
  `sanhi_image` text COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `module4_node1s`
--

LOCK TABLES `module4_node1s` WRITE;
/*!40000 ALTER TABLE `module4_node1s` DISABLE KEYS */;
/*!40000 ALTER TABLE `module4_node1s` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'ap_project'
--

--
-- Dumping routines for database 'ap_project'
--
